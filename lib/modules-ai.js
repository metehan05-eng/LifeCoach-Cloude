...
2. En mantıklı iki seçeneği belirle (optionA, optionB)
3. Hangisini önerdiğini söyle (recommendation)
4. Her seçenek için artı/eksi puanlaması yap (prosCons)
...

{
  ...
  "recommendation": "En mantıklı seçenek (optionA veya optionB)",
  "prosCons": {
    "optionA": {
  ...
  "simulation": {
    "optionA": { "m3": "3 ay sonra durum.", "m6": "6 ay sonra durum.", "m12": "12 ay sonra durum." },
    "optionB": { "m3": "3 ay sonra durum.", "m6": "6 ay sonra durum.", "m12": "12 ay sonra durum." }
  },
...
- recommendation mutlaka optionA veya optionB'den biri olmalı
- pros/cons score 1-10 arası (10 = en önemli)
- Her seçenek için en az 2, en fazla 5 madde
...
- coachVerdict 2-4 cümle, motive edici ve stratejik`;
  ...
  const messages = [
    { role: "system", content: systemPrompt },
    ...chatHistory,
    { role: "user", content: `Şu durumu/kararı analiz et: "${dilemma}"\n\nKarar analizi yap, summary ve recommendation mutlaka doldur.` },
  ];

  return callQwenModel(messages, 5000, { disableTools: true });
}
