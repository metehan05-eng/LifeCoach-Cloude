...
function isSupabaseConfigured() {
    ...
    const isUrlConfigured = url && !url.includes('YOUR_');
    const isKeyConfigured = key && !key.includes('YOUR_');
    const isServiceKeyConfigured = serviceKey && !serviceKey.includes('YOUR_');
    
    return isUrlConfigured && (isKeyConfigured || isServiceKeyConfigured);
}
