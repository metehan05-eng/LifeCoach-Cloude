...
export const WAFFLE_MODELS = {
  prompt: process.env.HF_WAFFLE_PROMPT_MODEL || 'meta-llama/Llama-3.1-8B-Instruct',
  promptVision: process.env.HF_WAFFLE_VISION_PROMPT_MODEL || 'meta-llama/Llama-3.2-11B-Vision-Instruct',
