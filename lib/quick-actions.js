...
Lütfen şunları yap:
1. Mevcut rutinimi anlamak için kısa sorular sor (uyku, çalışma saatleri, dikkat dağınıklığı).
2. Deep Work, Pomodoro veya time-blocking tabanlı önerilen bir sistem tasarla.
3. Haftalık üretkenlik tablosu gerekiyorsa extract_to_spreadsheet aracıyla Excel/Sheets formatında veri yapısı üret.
