...
Grafik verisi varsa trend yönünü belirt, destek/direnç seviyelerini yorumla.`,
  ...
  },
  {
    ...
    icon: '₿',
    category: 'finance',
    description: 'Yahoo Finance ile canlı kripto fiyatı, market cap, 24s değişim.',
...
📈 Günlük Aralık: {dayLow} - {dayHigh}

Piyasa trendini değerlendir.`,
    apiRequired: null,
    free: true,
    tool: {
      type: 'function',
      function: {
        ...
        description: 'Yahoo Finance ile kripto para fiyatı, market cap, 24s değişim ve günlük aralık al.',
        parameters: {
          type: 'object',
          properties: {
            coin_id: { type: 'string', description: 'Kripto para ID\'si (örn: bitcoin, ethereum, solana, dogecoin)' },
